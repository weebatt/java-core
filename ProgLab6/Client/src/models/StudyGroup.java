...
public class StudyGroup implements Serializable {
    ...
    public StudyGroup(String groupName, LocalDateTime creationDate, Coordinates coordinates, int studentsCount, Long expelledStudents, Integer transferredStudents, FormOfEducation formOfEducation, Person groupAdmin){
