...
/**
 * Класс выполняет чтение данных из файла, конвертацию из String to Collection, парсинг из CSV to Collection и наоборот.
 * @author butareyka
 */
public class FileManager implements FileMethods{
    public static Map<Long, StudyGroup> fileGroup = new LinkedHashMap<>();
    ...
    public void parseCollectionToCSV(String data) {
        try{
            ...
            System.err.println("Ошибка при работе с методом библиотеки: " + e.getMessage());
        }
    }
}