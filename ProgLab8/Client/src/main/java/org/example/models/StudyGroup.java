...
public class StudyGroup implements Serializable {
    ...
    public StudyGroup(String username, String groupName){
    }
    ...
    // Additional getter methods for Person fields
    public String getAdminName() {
        return groupAdmin != null ? groupAdmin.getAdminName() : null;
    }

    public long getHeight() {
        return groupAdmin != null ? groupAdmin.getHeight() : 0;
    }

    public EyesColor getEyeColor() {
        return groupAdmin != null ? groupAdmin.getEyeColor() : null;
    }

    public HairColor getHairColor() {
        return groupAdmin != null ? groupAdmin.getHairColor() : null;
    }

    public Country getNationality() {
        return groupAdmin != null ? groupAdmin.getNationality() : null;
    }

    public String getLocation() {
        return groupAdmin != null && groupAdmin.getLocation() != null ? groupAdmin.getLocation().getXAndY() : null;
    }

    public String getLocationName() {
        return groupAdmin != null && groupAdmin.getLocation() != null ? groupAdmin.getLocation().getLocationName() : null;
    }
