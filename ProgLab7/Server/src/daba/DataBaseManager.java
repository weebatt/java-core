...
public class DataBaseManager {
    ...
    private final String url = System.getenv("URL_DB");
...
//        createEnumFormOfEducation();
    ...
    public void insertIntoStudyGroup(long groupId, String userName, String groupName, LocalDateTime creationDate, int studentsCount, long expelledStudents, int transferredStudents, FormOfEducation formOfEducation, String groupAdminName) throws SQLException {
